...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getAttachment_DeleteService()
    {
        ...
        return new \phpbb\attachment\delete($this->get('config'), $a, $this->get('dispatcher'), $this->get('filesystem'), new \phpbb\attachment\resync($a), '../../Forum/');
    }
    ...
    protected function getAttachment_ManagerService()
    {
        ...
        return new \phpbb\attachment\manager(new \phpbb\attachment\delete($b, $a, $c, $this->get('filesystem'), new \phpbb\attachment\resync($a), '../../Forum/'), new \phpbb\attachment\resync($a), new \phpbb\attachment\upload($this->get('auth'), $this->get('cache'), $b, $this->get('files.upload'), $this->get('language'), $this->get('mimetype.guesser'), $c, $this->get('plupload'), $this->get('user'), '../../Forum/'));
    }
    ...
    protected function getAttachment_UploadService()
    {
        ...
        return new \phpbb\attachment\upload($this->get('auth'), $this->get('cache'), $this->get('config'), new \phpbb\files\upload($this->get('filesystem'), $this->get('files.factory'), $a, $this->get('php_ini'), $this->get('request')), $a, $this->get('mimetype.guesser'), $this->get('dispatcher'), $this->get('plupload'), $this->get('user'), '../../Forum/');
    }
    ...
    {
        $this->services['avatar.driver.gravatar'] = $instance = new \phpbb\avatar\driver\gravatar($this->get('config'), $this->get('upload_imagesize'), '../../Forum/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.local'] = $instance = new \phpbb\avatar\driver\local($this->get('config'), $this->get('upload_imagesize'), '../../Forum/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.remote'] = $instance = new \phpbb\avatar\driver\remote($this->get('config'), $this->get('upload_imagesize'), '../../Forum/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.upload'] = $instance = new \phpbb\avatar\driver\upload($this->get('config'), '../../Forum/', 'php', $this->get('filesystem'), $this->get('path_helper'), $this->get('dispatcher'), $this->get('files.factory'), $this->get('cache.driver'));
    ...
    {
        return $this->services['console.command.db.migrate'] = new \phpbb\console\command\db\migrate($this->get('user'), $this->get('language'), $this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), $this->get('filesystem'), '../../Forum/');
    }
    ...
    {
        return $this->services['console.command.db.revert'] = new \phpbb\console\command\db\revert($this->get('user'), $this->get('language'), $this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), $this->get('filesystem'), '../../Forum/');
    }
    ...
    {
        return $this->services['console.command.thumbnail.delete'] = new \phpbb\console\command\thumbnail\delete($this->get('user'), $this->get('dbal.conn'), '../../Forum/');
    }
    ...
    {
        return $this->services['console.command.thumbnail.generate'] = new \phpbb\console\command\thumbnail\generate($this->get('user'), $this->get('dbal.conn'), $this->get('cache'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.activate'] = new \phpbb\console\command\user\activate($this->get('user'), $this->get('dbal.conn'), $this->get('config'), $this->get('language'), $this->get('log'), $this->get('notification_manager'), $this->get('user_loader'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.add'] = new \phpbb\console\command\user\add($this->get('user'), $this->get('dbal.conn'), $this->get('config'), $this->get('language'), $this->get('passwords.manager'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.delete'] = new \phpbb\console\command\user\delete($this->get('user'), $this->get('dbal.conn'), $this->get('language'), $this->get('log'), $this->get('user_loader'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), '../../Forum/', 'php', 'phpbb_forums', 'phpbb_posts', 'phpbb_topics', 'phpbb_users');
    }
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this, '../../Forum/', $this->get('template'));
    }
    ...
    {
        $this->services['cron.task.core.queue'] = $instance = new \phpbb\cron\task\core\queue('../../Forum/', 'php', $this->get('config'), '../../Forum/cache/production/');
    ...
    {
        $this->services['cron.task.core.tidy_plupload'] = $instance = new \phpbb\cron\task\core\tidy_plupload('../../Forum/', $this->get('config'), $this->get('log'), $this->get('user'));
    ...
    {
        $this->services['cron.task.core.tidy_search'] = $instance = new \phpbb\cron\task\core\tidy_search('../../Forum/', 'php', $this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('dispatcher'));
    ...
    {
        return new \phpbb\db\extractor\mssql_extractor('../../Forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\mysql_extractor('../../Forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\oracle_extractor('../../Forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\postgres_extractor('../../Forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\sqlite3_extractor('../../Forum/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'phpbb_ext', '../../Forum/', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['feed.quote_helper'] = new \phpbb\feed\quote_helper($this->get('user'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['file_locator'] = new \phpbb\routing\file_locator($this->get('filesystem'), '../../Forum/');
    }
    ...
    {
        return new \phpbb\files\filespec($this->get('filesystem'), $this->get('language'), $this->get('php_ini'), $this->get('upload_imagesize'), '../../Forum/', $this->get('mimetype.guesser'), $this->get('plupload'));
    }
    ...
    {
        return new \phpbb\files\types\remote($this->get('config'), $this->get('files.factory'), $this->get('language'), $this->get('php_ini'), $this->get('request'), '../../Forum/');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'phpbb_migrations', '../../Forum/', 'php', 'phpbb_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), '../../Forum/', 'php', 'phpbb_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'phpbb_modules', '../../Forum/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email($this->get('user_loader'), $this->get('user'), $this->get('config'), '../../Forum/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\jabber($this->get('user_loader'), $this->get('user'), $this->get('config'), '../../Forum/', 'php');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), '../../Forum/', 'php', 'phpbb_user_notifications');
    ...
    {
        return $this->services['phpbb.help.controller.bbcode'] = new \phpbb\help\controller\bbcode($this->get('controller.helper'), $this->get('phpbb.help.manager'), $this->get('template'), $this->get('language'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['phpbb.help.controller.faq'] = new \phpbb\help\controller\faq($this->get('controller.helper'), $this->get('phpbb.help.manager'), $this->get('template'), $this->get('language'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['phpbb.report.controller'] = new \phpbb\report\controller\report($this->get('config'), $this->get('user'), $this->get('template'), $this->get('controller.helper'), $this->get('request'), $this->get('captcha.factory'), $this->get('phpbb.report.handler_factory'), $this->get('phpbb.report.report_reason_list_provider'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['phpbb.viglink.acp_listener'] = new \phpbb\viglink\event\acp_listener($this->get('config'), $this->get('language'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('phpbb.viglink.helper'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['router'] = new \phpbb\routing\router($this, $this->get('routing.chained_resources_locator'), $this->get('routing.delegated_loader'), 'php', '../../Forum/cache/production/');
    }
    ...
    {
        return $this->services['routing.helper'] = new \phpbb\routing\helper($this->get('config'), $this->get('router'), $this->get('symfony_request'), $this->get('request'), $this->get('filesystem'), '../../Forum/', 'php');
    }
    ...
    {
        return $this->services['routing.resources_locator.default'] = new \phpbb\routing\resources_locator\default_resources_locator('../../Forum/', 'production', $this->get('ext.manager'));
    }
    ...
    {
        return $this->services['template'] = new \phpbb\template\twig\twig($this->get('path_helper'), $this->get('config'), $this->get('template_context'), $this->get('template.twig.environment'), '../../Forum/cache/production/twig/', $this->get('user'), $this->get('template.twig.extensions.collection'), $this->get('ext.manager'));
    }
    ...
    {
        $this->services['template.twig.environment'] = $instance = new \phpbb\template\twig\environment($this->get('config'), $this->get('filesystem'), $this->get('path_helper'), '../../Forum/cache/production/twig/', $this->get('ext.manager'), $this->get('template.twig.loader'), $this->get('dispatcher'), array());
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006e134dc7000000004006ef6c(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'phpbb_bbcodes', 'phpbb_smilies', 'phpbb_styles', 'phpbb_words', '../../Forum/styles/');
    }
    ...
    {
        return $this->services['text_formatter.s9e.factory'] = new \phpbb\textformatter\s9e\factory($this->get('text_formatter.data_access'), $this->get('cache.driver'), $this->get('dispatcher'), $this->get('config'), $this->get('text_formatter.s9e.link_helper'), '../../Forum/cache/production/', '_text_formatter_parser', '_text_formatter_renderer');
    }
    ...
    {
        return $this->services['text_formatter.s9e.quote_helper'] = new \phpbb\textformatter\s9e\quote_helper($this->get('user'), '../../Forum/', 'php');
    }
    ...
    protected function getTextFormatter_S9e_RendererService()
    {
        ...
        $this->services['text_formatter.s9e.renderer'] = $instance = new \phpbb\textformatter\s9e\renderer($this->get('cache.driver'), '../../Forum/cache/production/', '_text_formatter_renderer', $this->get('text_formatter.s9e.factory'), $this->get('dispatcher'));
...
class phpbbtemplatetwiglexer_000000006e134dc7000000004006ef6c extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b14419799df5267495535 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b1441979dae5887622513 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b14419796105136696813 = array(
    ...
    {
        $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, 'set_environment', array('env' => $env), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;

        return $this->valueHolder5b14419799df5267495535->set_environment($env);
    }
    ...
    {
        $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;

        return $this->valueHolder5b14419799df5267495535->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;

        return $this->valueHolder5b14419799df5267495535->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b1441979dae5887622513 = $initializer;
    }
    ...
    {
        $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, '__get', array('name' => $name), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;

        if (isset(self::$publicProperties5b14419796105136696813[$name])) {
            return $this->valueHolder5b14419799df5267495535->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b14419799df5267495535;
    ...
    {
        $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;
    ...
    {
        $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, '__isset', array('name' => $name), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;
    ...
    {
        $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, '__unset', array('name' => $name), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;
    ...
    {
        $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, '__clone', array(), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;

        $this->valueHolder5b14419799df5267495535 = clone $this->valueHolder5b14419799df5267495535;
    }

    public function __sleep()
    {
        $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, '__sleep', array(), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;

        return array('valueHolder5b14419799df5267495535');
    }
    ...
    {
        return $this->initializer5b1441979dae5887622513;
    }
    ...
    {
        return $this->initializer5b1441979dae5887622513 && ($this->initializer5b1441979dae5887622513->__invoke($valueHolder5b14419799df5267495535, $this, 'initializeProxy', array(), $this->initializer5b1441979dae5887622513) || 1) && $this->valueHolder5b14419799df5267495535 = $valueHolder5b14419799df5267495535;
    }
    ...
    {
        return null !== $this->valueHolder5b14419799df5267495535;
    }
    ...
    {
        return $this->valueHolder5b14419799df5267495535;
    }
