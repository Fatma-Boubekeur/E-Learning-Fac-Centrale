...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000752769a4000000003f5c7dc6(
...
class phpbbtemplatetwiglexer_00000000752769a4000000003f5c7dc6 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b0037241d08b864754328 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b00372420d7b544770223 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b0037241939b403409086 = array(
    ...
    {
        $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, 'set_environment', array('env' => $env), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;

        return $this->valueHolder5b0037241d08b864754328->set_environment($env);
    }
    ...
    {
        $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;

        return $this->valueHolder5b0037241d08b864754328->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;

        return $this->valueHolder5b0037241d08b864754328->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b00372420d7b544770223 = $initializer;
    }
    ...
    {
        $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, '__get', array('name' => $name), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;

        if (isset(self::$publicProperties5b0037241939b403409086[$name])) {
            return $this->valueHolder5b0037241d08b864754328->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b0037241d08b864754328;
    ...
    {
        $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;
    ...
    {
        $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, '__isset', array('name' => $name), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;
    ...
    {
        $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, '__unset', array('name' => $name), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;
    ...
    {
        $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, '__clone', array(), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;

        $this->valueHolder5b0037241d08b864754328 = clone $this->valueHolder5b0037241d08b864754328;
    }

    public function __sleep()
    {
        $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, '__sleep', array(), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;

        return array('valueHolder5b0037241d08b864754328');
    }
    ...
    {
        return $this->initializer5b00372420d7b544770223;
    }
    ...
    {
        return $this->initializer5b00372420d7b544770223 && ($this->initializer5b00372420d7b544770223->__invoke($valueHolder5b0037241d08b864754328, $this, 'initializeProxy', array(), $this->initializer5b00372420d7b544770223) || 1) && $this->valueHolder5b0037241d08b864754328 = $valueHolder5b0037241d08b864754328;
    }
    ...
    {
        return null !== $this->valueHolder5b0037241d08b864754328;
    }
    ...
    {
        return $this->valueHolder5b0037241d08b864754328;
    }
