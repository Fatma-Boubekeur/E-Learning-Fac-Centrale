...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001d25bf8b0000000045160339(
...
class phpbbtemplatetwiglexer_000000001d25bf8b0000000045160339 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b0037402157d074774713 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b0037402526d970457384 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b0037401d88d883179156 = array(
    ...
    {
        $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, 'set_environment', array('env' => $env), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;

        return $this->valueHolder5b0037402157d074774713->set_environment($env);
    }
    ...
    {
        $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;

        return $this->valueHolder5b0037402157d074774713->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;

        return $this->valueHolder5b0037402157d074774713->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b0037402526d970457384 = $initializer;
    }
    ...
    {
        $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, '__get', array('name' => $name), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;

        if (isset(self::$publicProperties5b0037401d88d883179156[$name])) {
            return $this->valueHolder5b0037402157d074774713->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b0037402157d074774713;
    ...
    {
        $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;
    ...
    {
        $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, '__isset', array('name' => $name), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;
    ...
    {
        $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, '__unset', array('name' => $name), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;
    ...
    {
        $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, '__clone', array(), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;

        $this->valueHolder5b0037402157d074774713 = clone $this->valueHolder5b0037402157d074774713;
    }

    public function __sleep()
    {
        $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, '__sleep', array(), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;

        return array('valueHolder5b0037402157d074774713');
    }
    ...
    {
        return $this->initializer5b0037402526d970457384;
    }
    ...
    {
        return $this->initializer5b0037402526d970457384 && ($this->initializer5b0037402526d970457384->__invoke($valueHolder5b0037402157d074774713, $this, 'initializeProxy', array(), $this->initializer5b0037402526d970457384) || 1) && $this->valueHolder5b0037402157d074774713 = $valueHolder5b0037402157d074774713;
    }
    ...
    {
        return null !== $this->valueHolder5b0037402157d074774713;
    }
    ...
    {
        return $this->valueHolder5b0037402157d074774713;
    }
