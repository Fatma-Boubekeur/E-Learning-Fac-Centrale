...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006c263b31000000002ed716e9(
...
class phpbbtemplatetwiglexer_000000006c263b31000000002ed716e9 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b009d320cee2095687424 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b009d320d2ca471759479 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b009d320cafa154472974 = array(
    ...
    {
        $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, 'set_environment', array('env' => $env), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;

        return $this->valueHolder5b009d320cee2095687424->set_environment($env);
    }
    ...
    {
        $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;

        return $this->valueHolder5b009d320cee2095687424->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;

        return $this->valueHolder5b009d320cee2095687424->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b009d320d2ca471759479 = $initializer;
    }
    ...
    {
        $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, '__get', array('name' => $name), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;

        if (isset(self::$publicProperties5b009d320cafa154472974[$name])) {
            return $this->valueHolder5b009d320cee2095687424->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b009d320cee2095687424;
    ...
    {
        $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;
    ...
    {
        $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, '__isset', array('name' => $name), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;
    ...
    {
        $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, '__unset', array('name' => $name), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;
    ...
    {
        $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, '__clone', array(), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;

        $this->valueHolder5b009d320cee2095687424 = clone $this->valueHolder5b009d320cee2095687424;
    }

    public function __sleep()
    {
        $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, '__sleep', array(), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;

        return array('valueHolder5b009d320cee2095687424');
    }
    ...
    {
        return $this->initializer5b009d320d2ca471759479;
    }
    ...
    {
        return $this->initializer5b009d320d2ca471759479 && ($this->initializer5b009d320d2ca471759479->__invoke($valueHolder5b009d320cee2095687424, $this, 'initializeProxy', array(), $this->initializer5b009d320d2ca471759479) || 1) && $this->valueHolder5b009d320cee2095687424 = $valueHolder5b009d320cee2095687424;
    }
    ...
    {
        return null !== $this->valueHolder5b009d320cee2095687424;
    }
    ...
    {
        return $this->valueHolder5b009d320cee2095687424;
    }
