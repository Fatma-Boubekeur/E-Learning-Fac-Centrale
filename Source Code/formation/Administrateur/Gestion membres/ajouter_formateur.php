...
$grade=escape_dangerous_data($_POST['grade']);
      ...
      $sql="insert into utilisateur values('','$username',md5('$password'),'$nom',
         '$prenom','$email','Formateur','108284-200.png','')";
     ...
     $q2="insert into formateur values($last_inserted_id,'$grade')";
         ...
         $('button[name=btn_valider]').attr('disabled', true);
            ...
            $('button[name=btn_valider]').attr('disabled', false);
              ...
              <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="grade" id="grade" maxlength="40" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Grade'" placeholder="Grade" >
                    <span id="message_grade"></span>
              </div>

 <input type="text" name="profil" id="profil" value="Formateur" style="display: none;"> 
...
class="btn btn-primary btn-lg btn3d" style=" font-size: 18px ; " >Ajouter</button>
