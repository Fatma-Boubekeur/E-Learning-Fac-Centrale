...
$('#btn_valider_editer').click(function(){
valid=true;
...
if($('#profil_id').val()=='Profil utilisateur'){
  $('#profil_message').html('<span class="text-danger" style="font-size:16px;" >Veuillez choisir une des options suivantes (Formateur/Apprenant/Administrateur)</span><br>');
  $('#profil_message').show(); 
  $('#profil_id').css("border-color","#DA1900");
  $('#profil_id').css("background-color","#F2DEDE");
  valid=false;
}

if($('#profil_id').val()=='Formateur'){
...
if($('#profession').val()==''){
  $('#profession').css("border-color","#DA1900");
  $('#profession').css("background-color","#F2DEDE");
  $('#message_profession').html('<span class="text-danger" style="font-size:16px;" >Veuillez remplir ce  champs svp </span><br>');
  $('#message_profession').show(); 
  valid=false; } 
...
if($('#profil_id').val()=='Apprenant'){
 if($('#niveau').val()=='Niveau Licence'){
...
return valid && alert("Votre modification a bien été prise en compte ! ");
