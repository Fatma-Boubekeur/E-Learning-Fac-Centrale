...
$q="SELECT * from apprenant , table_niveau,utilisateur ,formation WHERE utilisateur.id_user=apprenant.id_user and apprenant.id_niveau_formation=table_niveau.id_niveau and table_niveau.id_formation=formation.id_formation";
...
$image=$row_image["image"];
                ...
                <h1 align="center" style="font-family: 'Vidaloka', serif; font-size: 40px;">Apprenants Détails </h1>  
                <br />  
               
                 <div class="row">
                 <div class="pull-left">
                 <ul id="topbar" style="padding-left: 5px;">
                <li><a href="ajouter_apprenant.php" class="btn btn-primary btn-primary"  style="font-size:20px; font-family:Georgia, serif;background-color: DodgerBlue;border-color: DodgerBlue; "><span class="glyphicon glyphicon-pencil" style="font-size:20px; background-color: DodgerBlue;border-color: DodgerBlue;"></span> Ajouter un nouvel apprenant</a></li>
                </ul>
              </div>
              </div>
                <div class="table-responsive">  
                     <table id="table_apprenants" class="table table-striped table-bordered mytable">  
                          <thead >  
                               <tr>  
                                    <th style="color: white; width: auto;">Nom d'utilisateur </th> 
                                    <th style="color: white; width: auto;">Nom</th>
                                    <th style="color: white; width: auto;">Prénom</th>
                                    <th style="color: white; width: auto;">Email</th>  
                      ...
                      <tbody>
                        ...
                        <td>
                         ...
                         <a href="editer_apprenants.php?id_apprenant=<?php echo $row["id_user"]; ?>">
                        <button type="button" class="btn btn-primary btn-lg btn3d" ><span class="glyphicon glyphicon-edit" ></span></button></a>

                        <a href="supprimer_apprenant.php?id_apprenant=<?php echo $row["id_user"]; ?>" onclick="return confirm('Etes-vous sûr de vouloir supprimer cet apprenant ?');">
