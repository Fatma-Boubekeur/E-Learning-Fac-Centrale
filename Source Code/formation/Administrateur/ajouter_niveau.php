...
if (isset($_POST["btn_ajouter"])) {
  ...
  $q="insert into table_niveau values('','$nom_niveau_de_la_formation',$id_formation)";
    ...
    <div class="signup-form">
        <form action="" method="post" id="formulaire" >
             ...
             <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="nom_niveau_de_la_formation" id="nom_niveau_de_la_formation"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nom du niveau de la formation'" placeholder=" Nom du niveau de la formation">
...
return valid && alert(" Niveau du formation ajouté avec succés ! ");
