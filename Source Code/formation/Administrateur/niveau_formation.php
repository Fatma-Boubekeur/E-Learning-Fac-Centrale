...
$q2="select * from table_niveau where id_formation=$id_formation";
...
$image=$row_image["image"];
                ...
                <h1 align="center" style="font-family: 'Playfair Display', serif; font-size: 40px;">Les niveaux de la formation <?php 
                    $id_formation=$_GET["id_formation"];
                    $q="SELECT * from formation where id_formation=$id_formation";
                ...
                <li><a href="ajouter_niveau.php?id_formation=<?php echo $_GET["id_formation"]; ?>" class="btn btn-primary btn-primary"  style="font-size:20px; font-family:Georgia, serif; background-color: #657cc3; border-color:#657cc3;"><span class="glyphicon glyphicon-pencil" style="font-size:20px;"></span> Ajouter un niveau de formation </a></li>
                </ul>
              </div>
              </div>
                ...
                <div class="table-responsive" style="margin-bottom: 100px;">  
                     <table id="table_niveau_formation" class="table table-striped table-bordered mytable" >  
                          <thead >  
                               <tr>  
                                    <th style="color: white; width: auto;">Niveau</th> 
                      ...
                      <tbody>
                        ...
                        <tr> 
                        <td><?php  echo $row2["niveau_etude"]; ?> </td>
                        
                        <td style="text-align: center;">
                        <a href="module.php?id_formation=<?php echo $row2["id_formation"]; ?>&&id_niveau=<?php echo $row2["id_niveau"];?>">
                        <button type="button" class="btn btn-primary btn-lg btn3d"
                        style="background-color: #657cc3;border-color: #657cc3; font-size: 21px;" >Afficher les modules </button></a> 

                        


                        <a href="editer_niveau.php?id_formation=<?php echo $row2["id_formation"]; ?>&&id_niveau=<?php echo $row2["id_niveau"];?>">
                        <button type="button" class="btn btn-primary btn-lg btn3d"
                        style="background-color: #657cc3;border-color: #657cc3; font-size: 21px;" ><span class="glyphicon glyphicon-edit" style="background-color: #657cc3;border-color: #657cc3;"></span></button></a> 




                        <a href="supprimer_niveau.php?id_formation=<?php echo $row["id_formation"]; ?>&&id_niveau=<?php echo $row2["id_niveau"];?>" onclick="return confirm('Etes-vous sûr de vouloir supprimer ce niveau de formation ?');">
...
$(document).ready(function() {
    $('#table_niveau_formation').DataTable( {
        "language": {
