                                    ...
                                    <div id="account" class="tab-pane active">
                                        <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-4 control-label" style=" font-weight:bold; font-family:'Playfair Display', serif;font-size: 18px;">Image</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-md-4 control-label" style=" font-weight:bold; font-family:'Playfair Display', serif;font-size: 18px;">Nom d'utilisateur</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-md-4 control-label" style=" font-weight:bold; font-family:'Playfair Display', serif;font-size: 18px;">Nom complet</label>
...
<span id="nom_message"></span>
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-md-4 control-label" style=" font-weight:bold; font-family:'Playfair Display', serif;font-size: 18px;">Email</label>
                                                <div class="col-md-6">
                                                    <div class="form-control-material">
         ...
         $('button[name=submit]').attr('disabled', true);
            ...
            $('button[name=submit]').attr('disabled', false);
                                        ...
                                        <div class="form-group" style="margin-bottom: 30px;">
                                                <label for="inputEmail3" class="col-md-4 control-label" style=" font-weight:bold; font-family:'Playfair Display', serif;font-size: 18px;">Numéro téléphone</label>
