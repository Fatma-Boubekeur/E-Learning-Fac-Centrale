...
<body style="padding: 0px;" >
 <?php
                ...
                $q="select * from chapitre where id_chapitre=$id_chapitre and id_module=$id_module";
...
$image=$row_image["image"];
                ...
                <div class="col-md-4" style="margin-top: 100px;margin-bottom:300px;">
                ...
                <div class="col-md-8 col-lg-8 " style="background-color: ;">            
                    <h1 class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 37px; margin-left: 40px;">Modifier chapitre</h1>
                    <div class="panel panel-default">
                        <div class="panel-body">
                    <form class="form-horizontal" role="form" method="post" action="action_editer.php?id_module=<?php echo $_GET["id_module"] ?>&id_chapitre=<?php echo $_GET["id_chapitre"]?>">
               ...
               <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-control-material">
                                            <input type="text" class="form-control" placeholder="Nom du chapitre" style="font-size: 22px;" name="nom_chapitre" 
                                            id="nom_chapitre" value="<?php
                                            echo $row["nom_chapitre"];
                                             ?>">
                ...
                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                            <textarea class="form-control" rows="5" cols="5" placeholder="Description du cours" style="font-size: 22px;" name="description" id="description"><?php
                ...
                <div class="form-group margin" style="margin-top: 40px; margin-bottom: 20px;">
                    ...
                    <button type="submit" name="btn_valider" id="btn_ajouter" 
