...
if (isset($_POST["btn_valider"])) {
  ...
  header("Location: choisir_chapitre.php?id_module=$id_module");
}
...
<div class="container" >
                ...
                <div   style="display: table; margin: 0 auto;width: 800px;">            
                    <h1 class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 37px; ">Veuillez choisir un module </h1>
