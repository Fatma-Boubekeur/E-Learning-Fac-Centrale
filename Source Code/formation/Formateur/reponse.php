...
?>
                ...
                <h3 align="center" style="font-family: 'Playfair Display', serif; font-size: 23px;">Liste des réponses de la question : 
                    <?php 
                     ...
                     $q4="select * from questions where id_question=$id_question and id_quiz=$id_quiz";
                     $res4=mysqli_query($link,$q4)or die(mysqli_error($link));
                     $row4=mysqli_fetch_assoc($res4);
                     $nom=$row4["contenue_question"];
                     echo $nom; 
                   ?> 
...
$q_reponse="select * from reponses where id_question=$id_question";
$res_reponse=mysqli_query($link,$q_reponse)or die(mysqli_error($link));
...
?>
                ...
                <div class="table-responsive" style="margin-bottom: 100px;"> 
                     <table id="table_reponse" class="table table-striped table-bordered mytable">  
                      ...
                      <tbody>
                        ...
                        <?php 
                        $nb_rows=0;
                        while($row_reponse=mysqli_fetch_assoc($res_reponse)){
                         $nb_rows++;
                        ...
                        <td> 
                            <?php echo $row_reponse["reponse"]; ?>
                        </td>  
                        <td> 
                            <?php if($row_reponse["correct"]==1){
                              echo "Oui";
                            }else{
                              echo "Non";
                            } ?>
                        ...
                        <a href="editer_reponse.php?id_chapitre=<?php echo $_GET["id_chapitre"]; ?>&id_module=<?php echo $_GET["id_module"];?>&id_question=<?php echo $_GET["id_question"]; ?>&id_reponse=<?php echo $row_reponse["id_reponses"] ?>&id_quiz=<?php echo $_GET["id_quiz"]; ?>">
                        ...
                        <a href="supprimer_reponse.php?id_chapitre=<?php echo $_GET["id_chapitre"]; ?>&id_module=<?php echo $_GET["id_module"]; ?>&id_question=<?php echo $_GET["id_question"];  ?>&id_quiz=<?php echo $_GET["id_quiz"]; ?>&id_reponse=<?php echo $row_reponse["id_reponses"] ?>"

                         onclick="return confirm('Etes-vous sûr de vouloir supprimer cette réponse ?');">
