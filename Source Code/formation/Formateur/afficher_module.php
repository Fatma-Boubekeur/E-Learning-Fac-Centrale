...
$image=$row_image["image"];
                ...
                <h1 align="center" style="font-family: 'Playfair Display', serif; font-size: 40px;">Liste des modules  </h1>  
                <br />  
                ...
                <div class="table-responsive">  
                     <table id="table_module" class="table table-striped table-bordered mytable">  
                      ...
                      <tbody>
                        ...
                        <td>
                        <a href="liste_chapitre_module.php?id_module=<?php echo $row["id_module"]?>">
                        <button type="button" class="btn btn-primary btn-lg btn3d"
                        style=" background-color:#1E90FF;border-color: #1E90FF font-size: 24px;" >Consulter les chapitres de module</button></a> 
