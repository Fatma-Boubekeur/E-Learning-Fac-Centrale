...
$q_question="select * from questions where id_quiz=$id_quiz";
$res_question=mysqli_query($link,$q_question)or die(mysqli_error($link));
...
?>
                ...
                <h3 align="center" style="font-family: 'Playfair Display', serif; font-size: 30px;">Liste des questions du quiz 
                    <?php 
                     ...
                     $q4="select * from quiz where id_quiz=$id_quiz and id_chapitre=$id_chapitre and id_module=$id_module";
                ...
                <div class="table-responsive" style="margin-bottom: 100px;"> 
                     <table id="table_question" class="table table-striped table-bordered mytable">  
                          ...
                          <thead >  
                               <tr> 
                                    <th style="color: white; width: auto;">#</th> 
                                    <th style="color: white; width: auto;">Question</th> 
                                    <th style="color: white; width: auto;">Note</th>
                      ...
                      <tbody>
                                   <a href="type_question.php?id_chapitre=<?php echo $_GET["id_chapitre"]; ?>&id_module=<?php echo $_GET["id_module"];?>&id_quiz=<?php echo $_GET["id_quiz"]; ?>&id_question=<?php echo $row_question["id_question"]; ?>" style="margin-left: 610px; font-size: 15px;">

                        <button type="button" class="btn btn-primary btn-lg btn3d" style="background-color:#1E90FF;border-color: #1E90FF;">Ajouter une question</span></button></a>
                        ...
                        <?php 
                        $nb_rows=0;
                        while($row_question=mysqli_fetch_assoc($res_question)){
                         $nb_rows++;

                          ?>
                        <tr>
                        <td><?php  echo $nb_rows; ?> </th></td> 
                        <td> 
                            <?php echo $row_question["contenue_question"]; ?>
                        </td>  
                        <td> 
                            <?php echo $row_question["note"]; ?>
                        </td>
                        <td>
                        <a href="reponse.php?id_chapitre=<?php echo $_GET["id_chapitre"]; ?>&id_module=<?php echo $_GET["id_module"]; ?>&id_question=<?php echo $row_question['id_question']; ?>&id_quiz=<?php echo $_GET["id_quiz"]?>">

                        <button type="button" class="btn btn-primary btn-lg btn3d"
                        style=" background-color:#1E90FF;border-color: #1E90FF font-size: 24px;" >Consulter les réponses de la question</button></a> 



                        

                        <a href="editer_question.php?id_chapitre=<?php echo $_GET["id_chapitre"]; ?>&id_module=<?php echo $_GET["id_module"];?>&id_quiz=<?php echo $_GET["id_quiz"]; ?>&id_question=<?php echo $row_question["id_question"]; ?>">

                        <button type="button" class="btn btn-primary btn-lg btn3d" style="background-color:#1E90FF;border-color: #1E90FF";  ><span class="glyphicon glyphicon-edit" ></span></button></a>

                        <a href="supprimer_question.php?id_chapitre=<?php echo $_GET["id_chapitre"]; ?>&id_module=<?php echo $_GET["id_module"]; ?>&id_quiz=<?php echo  $_GET["id_quiz"];  ?>&id_question=<?php echo  $row_question["id_question"]; ?>"

                         onclick="return confirm('Etes-vous sûr de vouloir supprimer cette question ?');">
