...
$q_quiz_editer_valider="update quiz set nom_quiz='$nom_quiz' where id_chapitre=$id_chapitre and id_module=$id_module ";

mysqli_query($link,$q_quiz_editer_valider)or die(mysqli_error($link));
...
<?php
                ...
                $id_chapitre=$_GET["id_chapitre"];
                $id_module=$_GET["id_module"];
                $q_quiz_editer="select * from quiz where id_chapitre=$id_chapitre and id_module=$id_module ";
                $res_quiz_editer=mysqli_query($link,$q_quiz_editer) or die(mysqli_error($link));
                $row_quiz_editer=mysqli_fetch_assoc($res_quiz_editer) or die(mysqli_error($link));
?> 
    
       
            
                <div class="col-md-6 col-lg-6 " style="margin-top: 0px;margin-left:80px;">            
                    <h1 class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 37px; margin-left: 40px;margin-top: 0px;">Modifier quiz</h1>
               ...
               <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-control-material">
                                            <input type="text" class="form-control"  style="font-size: 22px;" name="nom_quiz"
                                            value="<?php  echo $row_quiz_editer["nom_quiz"]; ?>" 
                                            >
