...
<div class="parallax cover overlay height-400" style="margin-top: 60px; " >
        <img class="parallax-layer" data-auto-offset="true" data-auto-size="false" src="images/streamline-textbook-2.jpg" alt="Learning Cover">
        <div class="parallax-layer overlay overlay-full overlay-bg-white bg-transparent" data-opacity="true" data-speed="8">
            <div class="v-center">
                <div class="page-section">
                    <h1 class="text-display-2 overlay-bg-white margin-v-0-15 inline-block" style="font-size: 45px; text-align: center; font-family: 'Rozha One', serif; margin-left: 280px;">Gestion des cours</h1>
                    <br/>
