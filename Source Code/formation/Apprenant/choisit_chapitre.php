...
if (isset($_POST["btn_valider"])) {
  ...
  header("Location: choisir_quiz.php?id_module=$id_module&id_chapitre=$id_chapitre");
}
...
$image=$row_image["image"];
                ...
                <div class="col-md-10 col-lg-10 " style="background-color: ;margin-left: 80px;">            
                    <h1 class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 37px; margin-left: 40px;">Veuillez choisir un chapitre  </h1>
                   ...
                   <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label"  style="font-size: 24px;font-family:'Playfair Display', serif;text-align: left; ">Chapitre</label>
                                    <div class="col-sm-9">
                                        <?php 
                                       ...
                                       ?>
                                        ...
                                        while($row2=mysqli_fetch_assoc($res2)){
                                         ?>
                                         <option value="<?php echo $row2["id_chapitre"]?>" style="font-size: 22px;">
