...
if (isset($_POST["btn_valider"])) {
  ...
  header("Location: choisit_chapitre.php?id_module=$id_module");
}
...
$image=$row_image["image"];
                ...
                <div class="col-md-10 col-lg-10 " style="background-color: ;margin-left: 80px;">            
                   ...
                   <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label"  style="font-size: 24px;font-family:'Playfair Display', serif;text-align: left; ">Module</label>
                                    <div class="col-sm-9">
                                        <?php 

                                          $id_user=$_SESSION['id_user_session'];
                                          $q="select id_niveau_formation from apprenant where id_user=$id_user";

                                          $res=mysqli_query($link,$q)or die(mysqli_error($link));
                                          $row=mysqli_fetch_assoc($res);
                                          $id_niveau=$row["id_niveau_formation"];
                                       ...
                                       ?>
                                        ...
                                        while($row2=mysqli_fetch_assoc($res2)){
                                         ?>
                                         <option value="<?php echo $row2["id_module"]?>" style="font-size: 22px;">
