...
if (isset($_POST["btn_valider"])) {
  ...
  header("Location: passer_quiz.php?id_module=$id_module&id_chapitre=$id_chapitre&id_quiz=$id_quiz");
}
...
$image=$row_image["image"];
                ...
                <div class="col-md-10 col-lg-10 " style="background-color: ;margin-left: 80px;">            
                    <h1 class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 37px; margin-left: 40px;">Veuillez choisir un Quiz  </h1>
                   ...
                   <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label"  style="font-size: 24px;font-family:'Playfair Display', serif;text-align: left; ">Quiz</label>
                                    <div class="col-sm-9">
                                        <?php 
                                          ...
                                          $q2="select * from quiz where id_module=$id_module and id_chapitre=$id_chapitre";
                                       ...
                                       ?>
                                        ...
                                        while($row2=mysqli_fetch_assoc($res2)){
                                         ?>
                                         <option value="<?php echo $row2["id_quiz"]?>" style="font-size: 22px;">
                                             
                                          <?php echo $row2["nom_quiz"]; ?>
                                         </option>   
                                         <?php } ?>   
